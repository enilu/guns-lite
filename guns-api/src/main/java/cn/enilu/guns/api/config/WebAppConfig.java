...
public class WebAppConfig extends WebMvcConfigurerAdapter {
    ...
    public String[] EXCLUDE_PATH_PATTERN = {
            "/file/**","/offcialSite","/offcialSite/*","/druid/**","/validate/*", "/user/register", "/user/login","/user/info", "/error", "/user/logout","/swagger-resources","/v2/api-docs","/swagger-ui.html","/webjars/**"};
